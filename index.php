...
<body>
    ...
    <a href="teste.php">click aqui </a>
    <!-- !PAGE CONTENT! -->
    <div class="w3-content" style="max-width:1500px">

        <!-- Header -->
        <header class="w3-container w3-xlarge w3-padding-24">
            <a href="#" class="w3-left w3-button w3-white">Sites</a>
            <a href="#about" class="w3-right w3-button w3-white">About</a>
        </header>

        <!-- Photo Grid -->
        <div class="w3-row">
            <div class="w3-half coluna-1">
                <img src="https://cdn.pixabay.com/photo/2017/01/18/12/33/session-1989711_960_720.png">
                <img src="https://cdn.pixabay.com/photo/2017/01/18/12/33/session-1989711_960_720.png">
                <img src="https://cdn.pixabay.com/photo/2017/01/18/12/33/session-1989711_960_720.png">

            </div>

            <div class="w3-half coluna-2">
                <img src="https://cdn.pixabay.com/photo/2017/01/18/12/33/session-1989711_960_720.png">
                <img src="https://cdn.pixabay.com/photo/2017/01/18/12/33/session-1989711_960_720.png">
            </div>
        </div>
    ...
    <footer class="w3-light-grey w3-padding-64 w3-center" id="about">
        <h2>About</h2>
        <img src="https://cdn.pixabay.com/photo/2017/01/18/12/33/session-1989711_960_720.png" class="w3-image w3-padding-32" width="300" height="300">
        <form style="margin:auto;width:60%" action="/action_page.php" target="_blank">
            ...
            <div class="w3-section">
                <label><b>Mensagen</b></label>
                <input class="w3-input w3-border" required name="Message">
            </div>
            <button type="submit" class="w3-button w3-block w3-dark-grey">Enviar</button>
        </form>
        <br>
